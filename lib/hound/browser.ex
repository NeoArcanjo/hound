defmodule Hound.Browser do
  ...
  def user_agent(:phantomjs) do
    "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/538.1 (KHTML, like Gecko) PhantomJS/2.1.1 Safari/537.36"
  end
  ...
  def user_agent(:chrome_android_sp) do
    "Mozilla/5.0 (Linux; U; Android-4.0.3; en-us; Galaxy Nexus Build/IML74K) AppleWebKit/537.36 (KHTML, like Gecko) CrMo/16.0.912.75 Mobile Safari/535.7"
  end
